...
public class ObservationView2 extends EnvironmentView {
  static public class Provider extends ClassViewProvider {
    public Provider() {
      super(CritterbotProblem.class, ObservationView2.ID);
    }
  }

  public static final String ID = "zephyr.plugin.critterview.view.observation2";
  protected CritterbotProblem environment = null;
  double[] currentObservation;

  public ObservationView2() {
  }
