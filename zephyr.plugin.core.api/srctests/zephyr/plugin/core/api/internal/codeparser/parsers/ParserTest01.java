...
public class ParserTest01 {
  ...
  static final String[] expectedLabels = new String[] { "logged02FieldName", log01LabelInt, log01LabelFloat,
      "logged05Child01/logged", "logged06ArrayDouble[0]", "logged06ArrayDouble[1]", "logged07ArrayInt[0]",
      "logged07ArrayInt[1]", "logged08ArrayFloat[0]", "logged08ArrayFloat[1]", "logged09ArrayObject/[0]/logged",
      "logged09ArrayObject/[1]/logged", "logged10ArrayLabeled[0:element0]", "logged10ArrayLabeled[1:element1]",
      "logged11ArrayLabeled/[0:element0]/logged", "logged11ArrayLabeled/[1:element1]/logged",
